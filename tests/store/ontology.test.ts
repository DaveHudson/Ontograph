...
describe('useOntologyStore', () => {
  ...
  describe('updateClass', () => {
    it('updates existing class', () => {
      ...
      expect(useOntologyStore.getState().ontology.classes.get('http://example.org/Foo')!.label).toBe('Bar')
    })
  ...
  describe('object property operations', () => {
    ...
    it('updates an object property', () => {
      ...
      expect(useOntologyStore.getState().ontology.objectProperties.get('http://ex/rel')!.label).toBe('Relates')
    })
    ...
    it('removes an object property', () => {
      ...
      expect(useOntologyStore.getState().ontology.objectProperties.has('http://ex/rel')).toBe(false)
    })
  })
  ...
  describe('datatype property operations', () => {
    ...
    it('updates a datatype property', () => {
      ...
      expect(useOntologyStore.getState().ontology.datatypeProperties.get('http://ex/dp')!.label).toBe('Data')
    })
    ...
    it('removes a datatype property', () => {
      ...
      expect(useOntologyStore.getState().ontology.datatypeProperties.has('http://ex/dp')).toBe(false)
    })
  })
