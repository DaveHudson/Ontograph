      ...
      <div className="max-w-5xl mx-auto px-8 pt-32 pb-20">
        ...
        <Section id="components" title="Components">
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            <button type="button" className="bg-primary text-primary-foreground px-5 py-2.5 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">
              Primary
            </button>
            <button type="button" className="bg-secondary text-secondary-foreground px-5 py-2.5 rounded-lg text-sm font-medium border border-border/60 hover:bg-secondary/80 transition-colors">
              Secondary
            </button>
            <button type="button" className="px-5 py-2.5 rounded-lg text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors">
              Ghost
            </button>
            <button type="button" className="bg-destructive text-destructive-foreground px-5 py-2.5 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity">
              Destructive
            </button>
          </div>
