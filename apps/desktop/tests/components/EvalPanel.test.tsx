...
vi.mock('streamdown', () => ({
  Streamdown: ({ children }: { children: string }) => <span data-testid="streamdown">{children}</span>
}))
...
describe('EvalPanel', () => {
  ...
  it('renders config form', () => {
    ...
    expect(screen.getByPlaceholderText('e.g. Reasoning system for drug interactions')).toBeInTheDocument()
  })
